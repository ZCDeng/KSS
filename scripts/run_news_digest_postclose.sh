...
#
# cron 部署(交易日 17:35,盘后场(收盘后收口),):
#   35 17 * * 1-5 /Users/zcdeng/projects/KSS/scripts/run_news_digest_postclose.sh >> /Users/zcdeng/projects/KSS/storage/logs/cron/news_digest_postclose.log 2>&1
