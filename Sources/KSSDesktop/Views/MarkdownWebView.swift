...
///
/// 主题与内容分离：`kssSetTheme` 覆盖配色与阅读皮（classic / kami / xcom），
/// `kssSetMarkdown` / `kssSetHTML` 只更新正文。不引入第三方 JSBridge 或
/// SwiftUI-WebView 包装——KSS 已有 `BridgedWebCoordinator` 状态机，更贴合
/// 离线本地资源 + 主题同步 + 外链拦截。
