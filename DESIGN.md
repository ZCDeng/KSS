...
- Investment daily V1: the 20:00 job reads that day's PDF/HTML from Google Drive「左侧机会扫描」and writes it as the investment-analysis daily. Do not generate this page with the research harness. Daily HTML is a Kami commentary fragment (bold section labels, same body as 板块复盘投顾点评); do not wrap it in `.kss-report`.
